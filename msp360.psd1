@{
    ...
    Copyright = '(c) 2021 Aleksey Volkov. All rights reserved.'
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = @"
- New cmdlets:
    - Restore-MBSFile (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/restore-mbsfile)
    - Send-MBSLog (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/send-mbslog)
    - Get-MBSPlanStatus (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/get-mbsplanstatus)
    - Save-MBSLog (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/save-mbslog)
    - Import-MBSAgentConfig (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/import-mbsagentconfig)
    - Export-MBSAgentConfig (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/export-mbsagentconfig)
    - Repair-MBSVSS (https://kb.msp360.com/managed-backup-service/powershell-module/cmdlets/backup-agent/repair-mbsvss)

-Feature:
    - Sign module cmdlets with a code signing certificate.

- BugFix:
    - Small typos in New-MBSRestorePlan and Backup-MBSFile
    - New-MBSBackupPlan: Realtime schedule issue
"@
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDzmLB5cUcytNRb
# M+1lnlb+5iwfqb+PLFMRE53tjaTvtqCCC04wggVmMIIETqADAgECAhEA3VtfmfWb
...
# NwIBFTAvBgkqhkiG9w0BCQQxIgQgBImb5FtSqtEFNgMNJpVtC0uADVXBzVMlK5Yo
# pGKUI1kwDQYJKoZIhvcNAQEBBQAEggEAiZLLqtjmgBA7SMWI8GYXVtXuzpVMDDMW
# Ty2JO9xGEGkTBLVvBBwYopJ2u/Ujho+stnR20dMwDEkg4RQKSMnMpwO37BoNdXrn
# N7u4snR3J2qToPhXw3gDOQT/6gS7h+IRgVT09+VzqaSG2+2UsIpAe017s6TCEfz3
# ql4n+1TQl1eLMqH2Uh2vPBFuVCZaDYADwdDQEXKTCMAxUmhPJhEO4CjRKt22kaRm
# KsVUwGSz9QH52lcAbk5gKzPPCHU3kGrKUSZI+gYzDSiUM2vuyckB9KSAXlyIiJeA
# llg4Ymb7NVIUsvxVB5YI8yL5O9QMJRyTYn8HlljZz7hB5F2tHTGuoqGCDUUwgg1B
...
# MA0GCWCGSAFlAwQCAQUABCDc/4Tb9EvChz9KCXTxfKr9MN4XNac+GdeRnkfMbVwK
# BQIRANigaluQmLpklhDN7QZe22EYDzIwMjEwMTI2MDgxMTQyWqCCCjcwggT+MIID
...
# AQkDMQ0GCyqGSIb3DQEJEAEEMBwGCSqGSIb3DQEJBTEPFw0yMTAxMjYwODExNDJa
# MCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFOHXgqjhkb7va8oWkbWqtJSmJJvzMC8G
# CSqGSIb3DQEJBDEiBCB7z+wK2az+93McYjkOWp/LOpOP0B9iBtGJC+HcIJ9Z4jAN
# BgkqhkiG9w0BAQEFAASCAQBB4Gc/Bd6/16V7EHYSqupijOqaEuwBCb1Ne7sTbEY1
# CWxrFXkStMJl9ydjySHb8jAuPPIfRKnm4UA+AOXYJ07ud8BleRgN4Dy1Vx8ij3OC
# us5yux9kqermRL3O/q9AYq5TrQZc2hNC24Tky6OpJ8AKzSX63i66NSTTxnO0DKKO
# p1ygj14oxyU+nXRsHwwxw9rZb+Hzls+uQu8fuCidF/SfnwF32ynsiEbqyZrMp5QC
# qF/6iLVukNZvBh83ow/xgdtmKS9l+C5JqMrmaKNeRg5yMA0fVwB89kpZL7rpZqsm
# 4hhn+mk1VPuQde4zwpag5GScHnm+bVc812O0W8xv9xOD
