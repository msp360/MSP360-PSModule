function Install-MSP360Module {
    ...
    @(
        ...
        if ($Host.Version.Major -lt 5){
            ...
            if((Get-Module $_.Module -ListAvailable).Version -lt [System.Version]$_.Version){
            ...
            if((Get-PackageProvider -Name NuGet -ListAvailable).Version -lt [System.Version]"2.8.5.201"){
    ...
    if($AllowAlpha){
        Install-Module -Name msp360 -Force -AllowPrerelease:$AllowAlpha
    }else{
